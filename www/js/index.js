...
var app = {
    ...
    onOAuthLogin: function()
    {
    	...
    	else if (app.deviceReady)
    	{
	    	...
	    	app.ref = window.open('https://www.playinitium.com/ServletUserControl?suctype=oauth&authType=google', "_system");
	    	app.ref.addEventListener('loadstop', hideLoadingIndicator);
	    	app.ref.addEventListener('loaderror', showErrorLoading);
	    	app.ref.addEventListener('message', onIngameMessage);
    	}
    	else
    ...
    enterGame: function(){
    	...
    	{
	    	showLoadingIndicator();
	    	app.ref = cordova.InAppBrowser.open('https://www.playinitium.com/main.jsp', "_self", 'location=no,hidden=yes');
	    	app.ref.addEventListener('loadstop', hideLoadingIndicator);
	    	app.ref.addEventListener('loaderror', showErrorLoading);
    	}
    	else
...
function onIngameMessage(event)
{
